...
mentre per poter ascoltare il traffico di ree basterà una variabile di tipo \textit{AsyncSniffer}. 
...
\subsubsection*{RITA} %https://github.com/activecm/rita
...
iccome non riuscirebbero a trovare alcun dato, a meno che non sappiano della tecnica utilizzata. 
\vspace{2ex} \newline 
...
Questi ultimo lo decapsulano e lo inoltrano. 
...
\begin{center} 
    \includegraphics[width=0.5\textwidth]{../img/implementazione/icmp_tunnel_schemaGenerale.jpg} 
    \captionof{figure}{Architettura generale \textit{icmp tunnel}}
    \label{fig:icmpTunnel:architettura} 
\end{center}
%\begin{itemize}
