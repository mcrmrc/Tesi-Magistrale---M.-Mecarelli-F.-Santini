...
Molto probabilmente il tuo antivirus (AV) non rileverà e bloccherà nemmeno icmpdoor.
vspace{2ex} newline
ICMPdoor è scritto in Python e riesce ad aggirare le regole standard del firewall oltre agli antivirus più vecchie.
Sebbene esistessero alcuni script o proof-of-concept più vecchi, l'autore di icmpdoor ha creato uno strumento Python 3 che funziona su "la maggior parte, se non tutte" le distribuzioni Linux e Windows 10 purché sia possibile eseguire il ping dalla macchina A alla macchina B.
...
Questa canale consentirà di estrarre dati attraverso questo. 
\vspace{1ex} \newline
