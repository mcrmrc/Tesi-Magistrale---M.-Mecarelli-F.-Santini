...
Tuttavia RITA non supporta questo formato, ma solo i log di Zeek. 
...
Quindi tramite Zeek si sono estratti dai file pcap i log necessari che sono stati poi analizzati da RITA.  
%\begin{lstlisting}
...
il primo è un testo corto e lineare volto a simulare un comando, 
il secondo è un testo di lunghezza variabile, 
mentre il terzo è invece un testo la cui lunghezza incrementa ogni volta. 
L'odine di grandezza è dei Kilobytes; 
questo è stato scelto per non appesantire troppo il carico di rete ed evitare lunghi tempi di attesa. 
\vspace{1ex} \newline
