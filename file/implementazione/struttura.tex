...
\end{lstlisting}
\captionof{lstlisting}{File di configurazione} 
...
\begin{lstlisting}[
    ...
    dati_separati={}
\end{lstlisting}
\captionof{lstlisting}{Variabili dell'attaccante}
...
\end{lstlisting}
\captionof{lstlisting}{Metodo per connettersi ai proxy}
...
\begin{lstlisting}[
    ...
    for proxy in proxy_list:
        ...
        socket_proxy.close()
\end{lstlisting}
\captionof{lstlisting}{Invio del comando ai proxy}
...
\begin{lstlisting}[
    ...
    attack_function={} 
\end{lstlisting}
\captionof{lstlisting}{Variabili del proxy}
...
\end{lstlisting}
\captionof{lstlisting}{Setup del server}
...
\end{lstlisting} 
\captionof{lstlisting}{Ricezione dei dati dall'attaccante}
\label{script:proxy:setupServer}
...
\end{lstlisting}
\captionof{lstlisting}{Invio dei dati ricevuti dalla vittima}
\label{script:proxy:recExecCommand}
...
\end{lstlisting}
\captionof{lstlisting}{Variabili della vittima}
...
\end{lstlisting}
\captionof{lstlisting}{Metodo per la connesisone con i proxy}
...
\end{lstlisting}
\captionof{lstlisting}{Aspettandoi la connessione dei proxy}
...
\end{lstlisting}
\captionof{lstlisting}{Esecuzione del comando}
