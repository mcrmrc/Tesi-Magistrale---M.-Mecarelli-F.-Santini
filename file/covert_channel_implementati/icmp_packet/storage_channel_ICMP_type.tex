...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    \hline
    \textbf{Campo} & \textbf{Utilizzo} \\
    \hline
    Unused &  
    Dalle specifiche RFC 792 (e RFC 4434) dovrebbe essere 0. Tuttavia è comunque utilizzabile. 
    %href{https://www.rfc-editor.org/rfc/rfc792.html#:~:text=Destination%20Unreachable%20Message}{RFC 792} 
    %Tuttavia nel nostro caso è stato utilizzato per testare la presenza della \textit{Deep Packet Inspection}. 
    \\ 
    \hline
    Header+64 bits (ICMPv4) &  
    Nel campo si dovranno inserire l'header IP più 8 byte. 
    Nel nostro caso si è usato ICMP/IP ma può essere utilizzato anche TCP/IP o altri protocolli purchè lunghezza passata, 
    ...
    \\
    \hline
    Invoking Packet (ICMPv6) &  
    Nel campo, il pacchetto usatoper indicare l'errore, sarà quello con il protocollo IPV6 e ICMPv6. 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    %\\
    %\hline
\caption{Campi usati in Time Exceeded} 
\label{tabella:campi:TimeExceeded} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    \hline
    Unused (ICMPv4) &  
    Dalle specifiche RFC 792 %(e RFC 4434) 
    dovrebbe essere 0. Tuttavia è comunque utilizzabile. 
    %href{https://www.rfc-editor.org/rfc/rfc792.html#:~:text=Destination%20Unreachable%20Message}{RFC 792} 
    %Tuttavia nel nostro caso è stato utilizzato per testare la presenza della \textit{Deep Packet Inspection}. 
    \\ 
    \hline
    Pointer &  
    Indica l'ottetto in cui è presente l'errore. 
...
\caption{Campi usati in Parameter Problem} 
\label{tabella:campi:ParameterProblem} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    %\\
    %\hline 
\caption{Campi usati in Source Quench} 
\label{tabella:campi:SourceQuench} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    %\hline 
    %gateway &  
    %Il campo dovrà contenere un indirizzo IP valido. 
    ...
    %\\
    %\hline 
\caption{Campi usati in Redirect} 
\label{tabella:campi:Redirect} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    \hline
    Identifier &  
    Definisce l'identificativo delle richieste e può assumere un qualsiasi valore. 
    \\ 
    \hline
    Sequenza &  
    Dalle specifiche RFC 792 (e RFC 4443) viene incrementato ad ogni richiesta inviata. 
    Se il valore cambiasse in maniera 
    non strettamente crescente, %(ma variabile)
    la cosa potrebbe risultare sospetta. 
    Tuttavia può essere utilizzato. %per inserire le informazioni. 
    \\
    \hline 
    Data &  
    In questo campo il mittente può inserire quanti dati preferisce. 
    Ma per sicurezza la dimensione sarà
    ...
    %\\
    %\hline 
\caption{Campi usati in Echo Reques/Reply} 
\label{tabella:campi:Echo} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    \hline
    Sequenza &  
    Dalle specifiche RFC 792 viene incrementato ad ogni richiesta inviata. 
    Se il valore cambiasse in maniera 
    non strettamente crescente, %(ma variabile)
    la cosa potrebbe risultare sospetta. 
    Tuttavia può essere utilizzato. %per inserire le informazioni. 
    ...
    \hline 
    campi Timestamp &  
    Contiene i milliseocndi dalla mezzanotte UT e ciascun campo ha un ordine temporale specifico; 
    ...
    In ciascunodi essi verrà inserito un byte nella parte indicante i millisecondi. 
    \\
    \hline 
    Data &  
    In questo campo il mittente può inserire quanti dati preferisce. 
    ...
    %\\
    %\hline 
\caption{Campi usati in Timestamp Reques/Reply} 
\label{tabella:campi:Timestamp} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    %\\
    %\hline 
\caption{Campi usati in Information Reques/Reply} 
\label{tabella:campi:Information} 
\end{longtable} 
\end{center} 
...
\begin{longtable}{|p{0.25\textwidth}|p{0.55\textwidth}|} 
    ...
    \hline
    MTU &  
    Rappresenta la capacità massima del collegamento; 
    siccome il suo valore è variabile, potrà essere usato per inserire in esso dei dati. 
    \\ 
    \hline
    \hline
    Invoking Packet &  
    ...
    %\\
    %\hline 
\caption{Campi usati in Packet Too Big} 
\label{tabella:campi:PacketTooBig} 
\end{longtable} 
\end{center} 
