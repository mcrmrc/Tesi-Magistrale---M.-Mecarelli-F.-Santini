...
%\end{esempio} 
\vspace{1ex} \newline 
Nel nostro caso la risorsa condivisa sarà il pacchetto ICMP inviato. 
%In questo caso come risosrsa condivisa verranno utilizzate le tipologie di messaggi presenti nel protocollo ICMP.  
Il mittente scriverà i dati nei campi del messaggio così che il destinatario, una volta ricevuto, 
potrà poi leggere i valori codificati al loro interno. 
...
\import{./covert_channel_implementati/icmp_packet}{storage_channel_ICMP_type} 