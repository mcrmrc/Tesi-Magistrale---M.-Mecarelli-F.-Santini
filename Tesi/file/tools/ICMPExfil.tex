...
Some, if not all, IPS systems can get invalid ICMP packets. 
...
Unless they knew about this method there wouldn’t be any data for them to get. 
If they knew about this method they would then need to look at the time between packets and try to get a pattern. 
