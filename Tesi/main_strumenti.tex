...
L%a scelta degli strumenti è stata guidata dalla necessità di creare uno scenario di rete isolato ma rappresentativo di contesti reali, 
...
L'ambiente operativo si compone di una piattaforma di virtualizzazione per la creazione di macchine virtuali\ref{strumenti:virtualbox}, 
di un framework per la manipolazione e l'analisi dei pacchetti di rete\ref{strumenti:scapy}, e di strumenti per il rilevamento di 
potenziali minacce informatiche\ref{strumenti:RITA}.
Particolare attenzione sarà anche dedicata all'analisi di progetti esistenti \ref{strumenti:ICMPdoor} \ref{strumenti:ICMPexfill} \ref{strumenti:ICMPtunnel} 
