...
Per poter far ciò; sono state create, per ciascun entità necessaria, 
una macchina virtuale contenente Ubuntu. 
\vspace{1ex} \newline
...
\subsubsection*{RITA (Real Intelligence Threat Analytics)} %https://github.com/activecm/rita
...
\subsubsection*{ICMP Door} %https://github.com/krabelize/icmpdoor
