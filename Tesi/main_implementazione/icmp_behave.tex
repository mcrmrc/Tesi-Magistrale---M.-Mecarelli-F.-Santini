...
Il Codice \ref{listing:behaveCC:divisionebyte} mostra questo processo.  
\begin{lstlisting} 
data='m' 
data.hex=0x6D
...
\end{lstlisting}
\captionof{lstlisting}{Esempio dell'invio di un byte tramite due eventi}
...
%Un effetto collaterale potrà quindi essere la non ricezione dei messaggi 
