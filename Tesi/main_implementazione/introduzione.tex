...
La Figura\ref{fig:icmpTunnel:architettura:generale} illustra il suo schema di funzionamento generale. 
\begin{center} 
...
%Si possono quindi creare dei Socket
    ...
    (anche se non viene considerata una cifratura ma pià una decodifica del carattere
    \footnote{Questo perchè un carattere ASCII può essere codificato tramite un numero intero.}). 
