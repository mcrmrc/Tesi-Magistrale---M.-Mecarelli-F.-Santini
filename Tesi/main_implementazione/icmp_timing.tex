...
\begin{minipage}{\textwidth}
    \centering
    \captionof{figure}{Assegnazione degli intervalli con la distanza \cite{draw_io}} %di tempo 
...
In particoalre si sarinvieranno solo i caratteri stampabili. 
\vspace{2ex} \newline
...
%\vspace{2ex} \newline 
%Bisogna quindi impostare correttamente il valore minimo e massimo 
%affinche i dati vengano decodificati in maniera appropriata.  
...
in un campo del pacchetto mentre oppura una particolare tipologia di messaggio 
