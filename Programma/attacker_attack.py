...
class Attacker: 
    ...
    def start(self): 
        ...
        #------------------------ 
        self.thread_proxiesConnection=THREAD.PROXIES_CONECTION(self.proxy_list, self.proxy_port, self.lock_proxy_list) 
        ...
        if len(self.proxy_list)<=0: 
            ...
            exit(0) 
        self.thread_waitData=THREAD.WAIT_DATA(self.proxy_list) 
