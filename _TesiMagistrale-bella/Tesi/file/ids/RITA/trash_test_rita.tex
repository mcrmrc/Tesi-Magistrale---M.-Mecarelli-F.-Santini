Si è mandato un file contenente le password. Siccome le dimensioni erano di 26 KB si è ripetuto la cosa per questtro volte. 
\begin{center} 
\begin{longtable}{|c|c|c|c|} 
    ...
    Destination Unreachable & 55.6\% & 33m 33s & Nessuna \\ \hline 
    Echo Reply & \multicolumn{3}{c|}{SBAGLIATO} \\ \hline 
    Echo Request & 78\% & 28 4s & Low \\ \hline 
    CC Ibrido & 68.9\% & 11h 42m 34 s & High \\ \hline 
    Information Reply & 46.7\% & 41m 29s & Nessuna \\ \hline 
    Parameter Problem & 40.5\% & 40m 24s & Nessuna \\ \hline 
    Redirect & 46.1\% & 33m 26s & Nessuna \\ \hline 
    Source Quench & 45.7\% & 33m 10s & Nessuna \\ \hline 
    Time Exceeded & 55.6\% & 33m 33s & Nessuna \\ \hline 
    Timestamp Reply & 42.6\% & 32m 26s & Nessuna \\ \hline 
    \hline 
    \hline 
    \multicolumn{4}{c}{Non eseeguiti} \\
    \hline
    Echo Reply con cmapi & \multicolumn{3}{c|}{SBAGLIATO} \\ \hline 
    Echo Reply con payload & \multicolumn{3}{c|}{SBAGLIATO} \\ \hline 
    Echo Reply con entrambi & \multicolumn{3}{c|}{SBAGLIATO} \\ \hline 
    \hline 
\caption{Quali comunicazioni RITA ha rilevato} 
...
Il sottocampo \textbf{beacon} definisce i parametri che RITA utilizzerà 
per definire se una connessione è un beacon e in caso il punteggio daassegnargli. 
...
\vspace{2ex} \newline 
Qui9ndi. siccome i test effettuati con la configurazione di base non hanno generato alcun avvertimento sulla 
presenza di un anomalia, si è deciso di modificare le soglie per il calcolo del punteggio finale. 
\vspace{1ex} \newline 
