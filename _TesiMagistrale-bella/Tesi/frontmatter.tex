...
\thispagestyle{empty} %suppress page number
	...
	\end{minipage}%
	%\hspace{0.2cm}
	\includegraphics[width=0.28\textwidth]{img/frontmatter/logoDMI.png}
	
	\vspace{5 em}

	\begin{center}
		
		{\large \textcolor{blu_dmi}{\textsc{Tesi magistrale in Informatica}}}
		\vspace{8 em}
		
		{\Huge \textcolor{blu_dmi}{Sviluppo di un Covert Channel tramite il protocollo ICMP per l'esfiltrazione di dati}} 
		\vspace{10 em}
		
		\makebox[380pt][c]{\textcolor{blu_dmi}{\textit{Relatore} \hfill \textit{Laureando}}}
		\makebox[380pt][c]{\textcolor{blu_dmi}{\textbf{Prof. Santini Franceso \hfill  Mecarelli Marco}}}
