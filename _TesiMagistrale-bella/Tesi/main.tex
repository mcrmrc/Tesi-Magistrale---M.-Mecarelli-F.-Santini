...
%\section{Prima Parte} \addcontentsline{toc}{section}{\protect\numberline{}Introduzione}  
\section{Background} 
\import{main_background}{icmp} 
\import{main_background}{covert} 
\newpage 

\section{Strumenti Utilizzati}
\import{}{main_strumenti} \newpage   

\section{Implementazione \cite{repoGITHUB}} 
\import{main_implementazione}{introduzione} 
\subsection{Struttura della comunicazione fra le entità} 
\import{main_implementazione}{struttura_comunicazione}  
\subsection{Implementazione del Timing Covert Channel}
\import{main_implementazione}{icmp_timing} 
\subsection{Implementazione del Storage Covert Channel} 
\import{main_implementazione}{icmp_storage} 
\subsection{Implementazione del Behavioural Covert Channel} 
\import{main_implementazione}{icmp_behave} 
\subsection{Implementazione di un Hybrid Covert Channel} 
\import{main_implementazione}{icmp_hybrid} 
\newpage  
%\import{./file}{covert_channel_implementati} \newpage 
%Per ognuno di essi, dove possibile, si effettuerà una richiesta alla vittima; 
%prima partendo da un comando leggero (e.g \textbf{pwd}) per poi passare a comandi 
%sempre più difficili e quindi maggiormente rilevabili (e.g \textbf{cd /path; ls -l} 
%oppure \textbf{cat ./file\_grande}, \dots)
%
\section{Test e Risultati} 
\import{}{main_test} \newpage  
%\import{./file}{RITA} \newpage 
%
%\section*{Quarta Parte} \addcontentsline{toc}{section}{\protect\numberline{}Mitigazioni}  
